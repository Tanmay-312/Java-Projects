...
{
	private int installFee;		// fixed fee = 100;
	private int nbTV;
	...
	{
		return "Subscription [installFee=" + installFee + ", nbTV=" + nbTV + ", subscriber=" + subscriber + ", cycle="
				+ cycle + ", datee=" + datee + "]";
	}
